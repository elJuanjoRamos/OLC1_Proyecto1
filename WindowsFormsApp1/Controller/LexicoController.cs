...
namespace WindowsFormsApp1.Controller
{
    class LexicoController
    {
        ...
        //Analizador lexico para la cedena de entrada de los automatas
        public ArrayList AnalizerStringToEvaluate(String input)
        {
            int state = 0;
            ArrayList elements_of_input = new ArrayList();
                ...
                switch (state)
                {
                    case 0:
                        ...
                        else if (char.IsPunctuation(letra))
                        {
                            ...
                            {
                                case '.':
                                    elements_of_input.Add(letra.ToString());
                                    break;
                                case ',':
                                    elements_of_input.Add(letra.ToString());
                                    break;
                    ...
                    case 1:
                        ...
                        {
                            elements_of_input.Add(auxiliar);
                            auxiliar = "";
                            i--;
                            state = 0;
                        }
